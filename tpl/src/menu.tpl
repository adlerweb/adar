    <div id="menu">
    	...
    	{/if}
      {if $loginlevel >= 192}
      <div><a href="testings/paperInfo_form.html"><img src="vendor/koala-framework/library-silkicons/user_add.png" /> Record a Paper</a></div>
      <div><a href="testings/users_view.php"><img src="vendor/koala-framework/library-silkicons/user_add.png" /> Users View</a></div>
      <div><a href="testings/contacts_view.php"><img src="vendor/koala-framework/library-silkicons/user_add.png" /> Contacts View</a></div>
