...
echo "Data from form. $dateUpload,$dateModerated,$studentNo,$publishStatus,$abstract";

$sql = "INSERT INTO papers (dateUpload, dateModerated, studentNumber, publishedStatus, abstract) VALUES ('$dateUpload', '$dateModerated', '$studentNo', '$publishStatus', '$abstract')";
